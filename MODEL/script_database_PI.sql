...
CREATE TABLE IF NOT EXISTS `Geek-O-Sphere`.`Articles` (
  ...
  `sous-categorie` VARCHAR(50) NULL,
...
START TRANSACTION;
USE `Geek-O-Sphere`;
INSERT INTO `Geek-O-Sphere`.`Articles` (`idArticles`, `categorie`, `nom`, `description`, `image`, `quantité`, `idMagasins`, `prix`, `sous-categorie`) VALUES (1, 'Informatique', 'Razer deathadder elite', 'Souris gaming de la marque razer, une des meilleurs du marché si ce n\'est la meilleure.Equipé dela technologie chroma elle permet une person', 'deathadder_elite.png', 30, 1, 79.99, 'Souris');
INSERT INTO `Geek-O-Sphere`.`Articles` (`idArticles`, `categorie`, `nom`, `description`, `image`, `quantité`, `idMagasins`, `prix`, `sous-categorie`) VALUES (2, 'Informatique', 'Logitech 7B3F', 'Clavier Logitech de moyenne gamme.Bon produit pour ce prix.', 'logitech_73BF.png', 150, 2, 29.99, 'Clavier');
INSERT INTO `Geek-O-Sphere`.`Articles` (`idArticles`, `categorie`, `nom`, `description`, `image`, `quantité`, `idMagasins`, `prix`, `sous-categorie`) VALUES (3, 'High-tech', 'Hand spinner dorée', 'N\'achetez pas, vraiment...', 'hand_spinner_dorée.png', 100, 3, 20.00, 'divers');
INSERT INTO `Geek-O-Sphere`.`Articles` (`idArticles`, `categorie`, `nom`, `description`, `image`, `quantité`, `idMagasins`, `prix`, `sous-categorie`) VALUES (4, 'Informatique', 'Msi Revolution 4', 'Ordinateur portable gaming de haute gamme fait tourner la plupart des jeux récents', 'msi_revolution_4.png', 32, 4, 999.99, 'ordinateur portable');
INSERT INTO `Geek-O-Sphere`.`Articles` (`idArticles`, `categorie`, `nom`, `description`, `image`, `quantité`, `idMagasins`, `prix`, `sous-categorie`) VALUES (5, 'Informatique', 'Barette de RAM 8Go Corsair', 'Barette de mémoire vive de 8Go de la marque Corsair', 'ram8go_corsair.png', 100, 2, 32, 'Hardware');
